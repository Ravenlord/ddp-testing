...
--[[
 - Benchmark file for design problem "File Storage", solution "File Link".
 -
...
function prepare_data()
  ...
  prepare_file_paths('emp_img', 1000)
...
CREATE TABLE `employees` (
  ...
  query = [[
INSERT INTO `employees` (`name`, `department`, `phone`, `email`, `date_of_birth`, `image_path`)
  SELECT
    `emp_nam`.`name`,
    `emp_dep`.`department`,
    `emp_pho`.`phone`,
