...
--[[
 ...
 - Update the project of a single contractor (fixed id).
 -
...
dofile(pathtest .. "01_single-select-single-record.lua")
...
function benchmark()
  db_query('BEGIN')
  rs = db_query("UPDATE `employees` SET `project` = 'New Project' WHERE `type` = 3 AND `id` = 1186")
  db_query('ROLLBACK')
end
